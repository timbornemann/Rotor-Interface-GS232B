class Elevation {
  ...
  initScale() {
    ...
    // Zeichne Halbkreis-Bogen
    const path = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    path.setAttribute('d', 'M 20 180 A 80 80 0 0 1 180 180');
    ...
    marks.forEach((angle) => {
      ...
      // Im SVG: 0° = rechts (x=180, y=180), 90° = oben (x=100, y=100)
      ...
      const lineLength = angle % 30 === 0 ? 8 : 4; // Längere Linien für 30°-Schritte
      ...
      if (angle % 30 === 0 || angle === 90) {
        ...
        const textX = x - Math.cos(rad) * 15;
        const textY = y + Math.sin(rad) * 15;
